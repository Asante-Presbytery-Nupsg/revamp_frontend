  ...
  return (
    <div className="space-y-6">
      ...
      <Section
        ...
        desc="All attendance and events are logged against this session"
      >
        {active ? (
          <div className="space-y-4">
            <div className="flex items-center justify-between p-4 bg-[#E6F1FB] rounded-xl">
              <div>
                <p className="text-[14px] font-semibold text-[#0C447C]">
                  {active.name}
                </p>
          ...
          <div className="flex items-start justify-between gap-4">
            <div>
              ...
              <p className="text-[12px] text-slate-400 mt-1 leading-relaxed">
                ...
                for reporting — no new attendance or events can be logged
                against it. Members and shepherds carry over automatically.
              </p>
            </div>
            <button
              ...
              >
                <div className="mt-4 pt-4 border-t border-slate-100 space-y-4">
                  <Field
                    ...
                    hint="This will become the active session after archiving"
                  >
                    <input
                      value={newName}
                  ...
                  <div className="flex gap-3">
                    ...
                    <button
                      ...
                      disabled={!newName.trim() || archiveAndStart.isPending}
                    ...
                    >
                      {archiveAndStart.isPending
                        ? "Archiving…"
                        : `Archive ${active.name} → Start ${newName || "…"}`}
                    </button>
                  </div>
                </div>
              </motion.div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          ...
          <Field label="Start date">
            <input
              ...
              onChange={(e) =>
                setNewForm((f) => ({ ...f, startDate: e.target.value }))
              }
              className={inputCls}
            />
          </Field>
          <Field label="End date">
            <input
              ...
              onChange={(e) =>
                setNewForm((f) => ({ ...f, endDate: e.target.value }))
              }
              className={inputCls}
            />
          </Field>
